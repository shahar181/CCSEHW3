...
class BooksCollection:
    ...
    def get_book(self, book_id):
        ...
        try:
            ...
            logging.error(f"Invalid book ID provided: {book_id}")
            raise NotFoundError("Invalid book ID provided")  # Ensure this is raised

        book = self.books_collection.find_one({"_id": oid})
        if not book:
